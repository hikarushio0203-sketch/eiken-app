...
const INITIAL_DATABASE = {
  "3級": [
    ...
    { id: "3-v2", category: 'vocab', question: "The weather is very ______ today.", options: ["fine", "find", "fire", "five"], answer: 0, explanation: "晴れは fine です。" },
    { id: "3-v3", category: 'vocab', question: "My father works in a ______.", options: ["hospital", "hospitality", "hose", "horse"], answer: 0, explanation: "病院は hospital です。" },
    ...
    { id: "3-v5", category: 'vocab', question: "She bought a pair of ______.", options: ["shoe", "shoes", "show", "shown"], answer: 1, explanation: "靴は複数形で shoes です。" },
    // 熟語
    ...
    { id: "3-i5", category: 'idiom', question: "We are looking forward ______ seeing you.", options: ["to", "for", "at", "on"], answer: 0, explanation: "look forward to です。" },
    // 文法
    { id: "3-g1", category: 'grammar', question: "My sister usually ______ up at six o'clock.", options: ["get", "gets", "getting", "got"], answer: 1, explanation: "三人称単数現在形 gets です。" },
    ...
    { id: "3-c4", category: 'conversation', question: "A: May I speak to Ken?\nB: ______", options: ["Yes, you may.", "Speaking.", "I am Ken.", "Who are you?"], answer: 1, explanation: "電話で「私です」という表現です。" },
...
export default function App() {
  ...
  const fetchNewQuestions = async (level) => {
    ...
    if (!currentKey || currentKey.length < 5) {
      setDebugError("APIキーが正しく読み込めていません。Vercel設定を確認してください。");
      return;
    }
    ...
    形式は必ずJSONのみで返してください。
    { "questions": [ { "id": "uuid", "category": "分野", "passage": "文章", "question": "問題文", "options": ["4つ"], "answer": 0-3, "explanation": "解説" } ] }`;
    ...
    try {
      ...
      if (!response.ok) throw new Error("AI通信に失敗しました。");
