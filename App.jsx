...
// appIdから全ての記号を除去し、Firestoreのパスエラー（セグメント数不一致）を100%防ぐ
...
const INITIAL_DATABASE = {
  ...
  "準2級": [
    ...
    { id: "p2-g5", category: 'grammar', question: "Repairing my bike.", options: ["repair", "repaired", "repairing", "to repair"], answer: 1, explanation: "受動使役。" },
